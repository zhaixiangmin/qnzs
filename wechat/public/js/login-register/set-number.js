...
$('#mobile').blur(  function(){
			       ...
			       obj.ajax('/commons/checkMobile',{'mobile':$('#mobile').val()},function(data){
			            ...
			            if(data.status =='ERROR'){
                            ...
                            setNumberObj = JSON.stringify(setNumberObj);
                            $.cookie('setNumberObj', setNumberObj, {path: '/'}); // 存储到cookie(区域)




				           $.alert("该手机号已注册，请直接登录！").then(function () {
                              window.location.href="set_number_login.html";  //跳转到登录页面登录
