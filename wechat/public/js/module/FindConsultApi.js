...
FindConsultApi.findAccountById = function (data) {
    return Qnzs.ApiProxy('/pc/service/findAccountById', data, '专家详情');
};
//获取活跃组织
...
FindConsultApi.getReplysByQuestionId = function (data) {
    return Qnzs.ApiProxy('/pc/service/getReplysByQuestionId', data, '问题详情获取评论列表',1);
};
...
FindConsultApi.getExpAnswerList = function (data) {
    return Qnzs.ApiProxy('/pc/service/getExpAnswerList', data, '获取专家/组织已解答问题列表',1);
};
//问题管理新增接口(提问)
 ...
 * @returns {*}
 */
FindConsultApi.searchMrwbQuesList = function (data) {
    return Qnzs.ApiProxy('/pc/service/searchMrwbQuesList', data, '名人问吧列表',1);
};
/**
 * 首页/找咨询主页名人问吧列表
 * @param data {obj} 属性如下
 ...
 * @returns {*}
 */
FindConsultApi.indexMrwbQuesList = function (data) {
    return Qnzs.ApiProxy('/pc/service/indexMrwbQuesList', data, '首页/找咨询主页名人问吧列表',1);
};
/**
 * 判断是专家才能创建话题
 * @param data {obj} 属性如下
 ...
 * @returns {*}
 */
FindConsultApi.findAccountByIdmr = function (data) {
    return Qnzs.ApiProxy('/bg/accountExpert/findAccountById', data, '判断是专家才能创建话题');
};
/**
 * 我要吐槽
 * @param data {obj} 属性如下
...
//根据站内信ID获取站内信
FindConsultApi.userMessage = function (data) {
    return Qnzs.ApiProxy('/message/userMessage', data, '根据站内信ID获取站内信',1);
};
/**
 * 批量改变私信状态
 * @param data {obj} 属性如下
...
FindConsultApi.getMyQuestions = function (data) {
    return Qnzs.ApiProxy('/pc/service/getMyQuestions', data, '找咨询个人中心我的发布',1);
};
//关注专家 /取消关注专家
