 ...
 */
$(function () {
    var fun = PersonCenterApi.myConcernStations; // 定义调用函数
    ...
    function render_stationlist($listContent, stations) {
        ...
        for(var i=0; i<stations.length; i++) {
            ...
            html += '<a href="../young_family/detail.html?staId=' + station.staId + '" class="item clearfix borderBot" style="display: block;">';
    ...
    fun(params).then(function (data) {
        ...
        $('#focus_offservice_service_total').append('(' + data.total + ')');
