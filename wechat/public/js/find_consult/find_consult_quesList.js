$(document).ready(function() {
	var categoryId = Utils.getQueryString('categoryId');
	var qType = Utils.getQueryString('qType');
	...
	function render_helplist($listContent, helps, isClear) {
		...
		for (var i = 0; i < helps.length; i++) {
			...
			html+='<div class="l">';
			html+='<div class="circle"><img src="'+ Utils.compressByAli(item.photourl, 120, 120) +'"/></div>';
			html+='</div>';
			html+='<div class="r">';
			html+='<div class="up">';
