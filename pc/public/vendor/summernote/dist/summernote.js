...
(function (factory) {
  ...
  var func = (function () {
     ...
     *
     * - IE Compatibility Issue: //goo.gl/sRLOAo
     * - Scroll Issue: //goo.gl/sNjUc
     *
     * @param {Rect} rect
   ...
   *
   * See to //www.w3.org/TR/DOM-Level-2-Traversal-Range/ranges.html#Level-2-Range-Position
   *
   * @singleton
  ...
  */
  ...
  var Editor = function (context) {
    ...
    this.createLink = this.wrapCommand(function (linkInfo) {
      ...
      if (options.onCreateLink) {
        ...
        // if url doesn't match an URL schema, set // as default
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group">' +
                 ...
                 '<div class="form-group">' +
                   ...
                   '<input class="note-link-url form-control" type="text" value="//" />' +
                 '</div>' +
  ...
  var HelpDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="//summernote.org/" target="_blank">Summernote 0.8.6</a> · ',
