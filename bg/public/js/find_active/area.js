...
dsy.add("0_0_6",["湘桥区","潮安县","庵埠镇","饶平县","黄冈镇","潮安区"]);
dsy.add("0_0_7",["金平区","濠江区","龙湖区","潮阳区","潮南区","澄海区","南澳县","后宅镇"]);
dsy.add("0_0_8",["榕城区","普宁市","揭东县","曲溪镇","揭西县","河婆镇","惠来县","惠城镇"]);
dsy.add("0_0_9",["城区","陆丰市","海丰县","海城镇","陆河县","河田镇","东海镇","鹅埠镇"]);
dsy.add("0_0_10",["惠城区","惠阳区","博罗县","罗阳镇","惠东县","龙门县"]);
dsy.add("0_0_11",["莞城街道","南城街道","东城街道","万江街道","石龙镇","石排镇","茶山镇","企石镇","桥头镇","东坑镇","横沥镇","常平镇","虎门镇","长安镇","沙田镇","厚街镇","寮步镇","大岭山镇","大朗镇","黄江镇","樟木头镇","谢岗镇","塘厦镇","清溪镇","凤岗镇","麻涌镇","中堂镇","高埗镇","石碣镇","望牛墩镇","洪梅镇","道滘镇"]);
dsy.add("0_0_12",["香洲区","斗门区","金湾区"]);
dsy.add("0_0_13",["火炬高技术产业开发区","石岐区办事处","东区办事处","西区办事处","南区办事处","五桂山办事处","黄圃镇","南头镇","东凤镇","阜沙镇","小榄镇","东升镇","古镇镇","横栏镇","三角镇","民众镇","","南朗镇","港口镇","大涌镇","沙溪镇","三乡镇","板芙镇","神湾镇","坦洲镇"]);
...
dsy.add("0",["广东省","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","北京市","广西","海南省","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省","宁夏","新疆","香港","澳门","台湾省"]);

var s=["province","city","county"];//三个select的name
var opt0 = ["请选择省份","请选择地级市","请选择区、县"];//初始值
//新增
