...
function exportData(n) {
	var pageIndex = $('#signedAccList').datagrid("getPager").pagination("options").pageNumber;
	var pageSize = $('#signedAccList').datagrid("getPager").pagination("options").pageSize;

	window.location.href = Qnzs.path + '/activity/sign/bg/signedAcc/export?activityId=' + activityId + '&pageIndex=' + pageIndex + '&pageSize=' + pageSize;
}