	    /*表格初始化*/
	    $('#project-partake').datagrid({ title: '地区数据报表',  //表格名称           iconCls: 'icon-edit',  //图标
	           width:1500,   //表格宽度
	           height:520,   //表格高度，可指定高度，可自动
	           border:true,  //表格是否显示边框
	           url:base+'/bg/report/reportFormsDidList',   //获取表格数据时请求的地址
	           columns:[[
	             {field:'districtName',title:'统计平台',width:100},
	             {field:'readSum',title:'青年之声.智慧团建有效访问量',width:150},
	             {field:'questionSum',title:'有效提问量',width:150},
	             {field:'replyL100Sum',title:'单个用户提问超过100条的数量总计',width:100},
	             {field:'reply10QuesSum',title:'话题参与度',width:100},
	             {field:'replyQuesSum',title:'被回复问题数',width:100},
	             {field:'replySum',title:'找咨询评论数',width:100},
	             {field:'expReplySum',title:'专家参与回答问题数',width:100},
	             {field:'orgReplySum',title:'团组织用户参与回答问题数',width:100},
	             {field:'userRegisterCount',title:'注册用户数',width:100},
	             {field:'userCount',title:'用户数（累计）',width:100},
	             {field:'weixinUserNum',title:'移动端绑定数',width:100},
	             {field:'expCount',title:'专家数（累计）',width:100},
	             ...
	             {field:'subSysAdminCount',title:'下属系统管理员数',width:100},
	             ...
	             {field:'qnzjProjectCount',title:'青年之家活动发布数',width:100},
	             {field:'qnzjProjectEnrollCount',title:'青年之家活动报名数',width:100},
	             {field:'qnzjProjectReplySum',title:'青年之家活动评论数',width:100},
	             {field:'qnzjProjectScoreSum',title:'青年之家活动总评分',width:100},
...
//	             {field:'parentDname',title:'上级区域名称',width:100}
	          ]],
...
$('#exportBtn').bind('click', function(event) {
	...
	$.messager.confirm("操作提示", "您确定要导出当前条件的查询结果吗？", function(data) {
		if (data) {
			...
			window.location.href = Qnzs.path+'/bg/report/exportFormsDidList?reportType='+reportType+'&startTime='+startTime+'&keyWord='+keyWord+'&districtId='+getDistrictId();
		} else {
			return;
		}
	});
